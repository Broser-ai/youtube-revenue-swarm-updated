    ...
    <div className="bg-white border border-gray-200 rounded-3xl p-5 shadow-sm flex flex-col gap-5 w-full">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex justify-between items-center">
          ...
          <span className="text-[10px] font-bold text-[#10B981] tracking-wider uppercase flex items-center gap-1">
            <Sparkles className="w-3 h-3 text-[#10B981] animate-pulse" /> Opdateret live
          </span>
        </div>
